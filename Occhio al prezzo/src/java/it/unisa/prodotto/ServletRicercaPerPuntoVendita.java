 ...
 * @author andreapilato
 */
@WebServlet(name = "ServletRicercaPerPuntoVendita", urlPatterns = {"/ServletRicercaPerPuntoVendita"})
public class ServletRicercaPerPuntoVendita extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.print("<h1> prodotti </h1>");
            out.write(prodotti.toString());
