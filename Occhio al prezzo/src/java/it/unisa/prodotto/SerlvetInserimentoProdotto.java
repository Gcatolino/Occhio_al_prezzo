 ...
 * @author andreapilato
 */
@WebServlet(name = "SerlvetInserimentoProdotto", urlPatterns = {"/SerlvetInserimentoProdotto"})
public class SerlvetInserimentoProdotto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.print("<h1> prodotto inserito </h1>");
