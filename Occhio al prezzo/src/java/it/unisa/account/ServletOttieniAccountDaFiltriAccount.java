...
public class ServletOttieniAccountDaFiltriAccount extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.print("NOVAL");
                ...
                Logger.getLogger(ServletOttieniAccountDaFiltriAccount.class.getName()).log(Level.SEVERE, null, ex);
            }
